  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      'process.env': {
        ...
        LOCAL_HOSTED_FIELDS: JSON.stringify(process.env.LOCAL_HOSTED_FIELDS),
        LOCAL_HOSTED_FIELDS_ENDPOINT: JSON.stringify(process.env.LOCAL_HOSTED_FIELDS_ENDPOINT),
        LOCAL_HOSTED_CHECKOUT: JSON.stringify(process.env.LOCAL_HOSTED_CHECKOUT),
        LOCAL_HOSTED_CHECKOUT_ENDPOINT: JSON.stringify(process.env.LOCAL_HOSTED_CHECKOUT_ENDPOINT),
