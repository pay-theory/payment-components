...
export default async(inputParams) => {
    ...
    const onClickWrapper = () => {
        ...
        let hostedCheckout = window.open(hostedCheckoutUrl, '_blank', "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=700px,height=1000px,top="+(screen.height / 2)+",left="+(screen.width / 2))
